...
function M.force_reset_syntax()
  ...
  -- ==============================================================================
  -- NOTE: The following syntax highlighting block is generated by `color_analyze.lua`.
  -- Modern TrueColor themes (like TokyoNight, Catppuccin) break in macOS Terminal.app
  -- and MSYS2. This block acts as a dynamic 256-color compiler fallback.
  --
  -- IF YOU CHANGE YOUR COLORSCHEME (e.g. using a new lazy.nvim theme):
  -- 1. Open nvim-qt (or a TrueColor terminal).
  -- 2. Run `:colorscheme new-theme-name`.
  -- 3. Run `:ColorAnalyze`.
  -- 4. Replace the `highlight` commands below with the output from `:ColorAnalyze`.
  -- ==============================================================================
  vim.cmd([[
